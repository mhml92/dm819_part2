...
%  
%  The basic structure of a range tree consist of multiple 1-dimensional binary 
%  search trees ordered by dimensions.  
%  An $d$-dimensional Range-tree consist of $d$ levels where each level, $l$, is 
